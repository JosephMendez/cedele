...
<table class="shop_table woocommerce-checkout-review-order-table">
  ...
  <tfoot>
    ...
    <?php if (count(WC()->cart->get_coupons()) > 0) { ?>
      <tr class="cart-discount-label">
        <th colspan="3"><?php echo __('Discount', 'woocommerce'); ?></th>
      </tr>
    <?php } ?>
    ...
    <?php if($checkbox_redemp_point): ?>
    <tr class="fee">
      <th colspan="2">Use point</th>
      <td><span class="woocommerce-Price-amount amount woocommerce-Price-amount-front"><span><?php echo $use_point ?></span><span class="price-decima"></span></span></td>
    </tr>
    <?php endif; ?>
    ...
    if ( wc_tax_enabled() && WC()->cart->display_prices_including_tax() ):
        ...
        ?>
        <tr>
            <th class="product-name" scope="row" colspan="2"><?php esc_html_e( 'Tax', 'woocommerce' ); ?></th>
            <td class="product-total"><?= '$'.$cart_tax_totals['TAX-1']->amount ?></td>
        </tr>
    <?php endif; ?>

    <tr class="order-total">
      <th colspan="2"><?php esc_html_e( 'Total (inc. TAX)', 'woocommerce' ); ?></th>
