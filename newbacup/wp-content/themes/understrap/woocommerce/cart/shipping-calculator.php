...
<form class="woocommerce-shipping-calculator" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
  ...
  <section class="shipping-calculator-form" style="display:none;">
    ...
    <?php endif; ?>
    <?php $calc_shipping_token = WC()->customer->__get( 'calc_shipping_token' ); ?>
    <input type="hidden" name="calc_shipping_token" id="calc_shipping_token" value="<?php echo $calc_shipping_token;?>"/>
