					...
					'front' => [
						...
						'post_content' => join(
							...
							[
								...
								_x( 'Welcome to <span style="color:#b6007c" class="has-inline-color">Division 9</span> <span style="color:#72009b" class="has-inline-color">&amp;</span> 
								<span style="color:#7747fa" class="has-inline-color">the </span><strong><span style="color:#479ffa" class="has-inline-color">VMODEV</span></strong></h2>', 'Theme starter content', 'inclusive' ) .
								'<!-- /wp:heading -->
								</div>
								<!-- /wp:column -->
								...
								<p class="has-medium-font-size">' . _x( 'Huan rose', 'Theme starter content', 'inclusive' ) . '</p>
								<!-- /wp:paragraph -->
