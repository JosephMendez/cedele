...
?>
<ul class="wf_sub_tab">
    <li style="border-left:none; padding-left: 0px;" data-target="general"><a><?php _e('General','print-invoices-packing-slip-labels-for-woocommerce'); ?></a></li>
    <li data-target="invoice-number"><a><?php _e('Invoice Number','print-invoices-packing-slip-labels-for-woocommerce');?></a></li>
    <?php
    $title_arr=array();
