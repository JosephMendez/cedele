<?php
    ...
    class CDLS_Validation {
        ...
        /**
         * Campo obbligatorio
         * params: ('table_name', 'column', 'id!=1')
         * @return this
         */
        public function unique($query_string){

            $result = db_get_row($query_string);
            if ($result) {
                $this->errors[$this->name] = 'The field ' . $this->name . ' has existed.';
            }
            return $this;
        }
        ...
        public function min($length){
            ...
            if(is_string($this->value)){
                ...
                if(strlen($this->value) < $length){
                    $this->errors[$this->name] = 'The field '.$this->name.' must higher or equal than ' . $length;
                }
        ...
        public function max($length){
            ...
            if(is_string($this->value)){
                ...
                if(strlen($this->value) > $length){
                    $this->errors[$this->name] = 'The field '.$this->name.' must lower or equal than ' . $length;
                }
        ...
        public function equal($value){
            ...
            if($this->value != $value){
                $this->errors[$this->name] = 'The field '.$this->name.' is not equal.';
            }
            return $this;
        ...
        public function maxSize($size){
            ...
            if($this->file['error'] != 4 && $this->file['size'] > $size){
                $this->errors[$this->name] = 'This file '.$this->name.' exceeds the maximum size of '.number_format($size / 1048576, 2).' MB.';
            }
            return $this;
        ...
        public function ext($extension){
            ...
            if($this->file['error'] != 4 && pathinfo($this->file['name'], PATHINFO_EXTENSION) != $extension && strtoupper(pathinfo($this->file['name'], PATHINFO_EXTENSION)) != $extension){
                $this->errors[$this->name] = 'This file '.$this->name.' is not a '.$extension.'.';
            }
            return $this;
