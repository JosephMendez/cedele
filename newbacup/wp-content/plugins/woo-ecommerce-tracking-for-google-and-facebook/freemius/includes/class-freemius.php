...
------------------------------------------------------------------------------------------------------------------*/
        ...
        function has_api_connectivity( $flush_if_no_connectivity = false ) {
            ...
            if ( ! $this->should_run_connectivity_test( $flush_if_no_connectivity ) ) {
                ...
                /**
                 * @since 1.3.0 During dev mode, if there's connectivity - turn Freemius on regardless the configuration.
                 *
...
//			}
                ...
                if ( ! $is_valid ) {
                    ...
                    if ( ! $background || $this->is_paying() ) {
                        ...
                        if ( ! FS_Api::test() ) {
                             ...
                             *
                             * @author Vova Feldman (@svovaf)
                             * @since  1.3.0 Only show message related to one of the Freemius powered plugins. Once it will be resolved it will fix the issue for all plugins anyways. There's no point to scare users with multiple error messages.
                             */
                            $api = $this->get_api_site_scope();
        ...
        function _modify_plugin_action_links_hook( $links, $file ) {
            ...
            if ( ! empty( $deactivate_link ) ) {
                 ...
                 *
                 * @since 1.2.3.0 Always show the deactivation feedback form since we added automatic free version deactivation upon premium code activation.
                 */
