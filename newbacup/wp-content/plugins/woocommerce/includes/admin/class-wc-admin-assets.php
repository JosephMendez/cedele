...
if ( ! class_exists( 'WC_Admin_Assets', false ) ) :
	...
	class WC_Admin_Assets {
		...
		public function admin_scripts() {
			...
			wp_register_script( 'wc-shipping-time', WC()->plugin_url() . '/assets/js/admin/wc-shipping-time' . $suffix . '.js', array( 'jquery', 'jquery-blockui', 'wp-util' ), $version );
			wp_register_script( 'wc-shipping-distance', WC()->plugin_url() . '/assets/js/admin/wc-shipping-distance' . $suffix . '.js', array( 'jquery', 'jquery-blockui', 'wp-util' ), $version );
			wp_register_script( 'wc-shipping-rate', WC()->plugin_url() . '/assets/js/admin/wc-shipping-rate' . $suffix . '.js', array( 'jquery', 'jquery-blockui', 'wp-util' ), $version );
