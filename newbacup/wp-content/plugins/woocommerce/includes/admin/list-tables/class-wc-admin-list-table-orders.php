...
class WC_Admin_List_Table_Orders extends WC_Admin_List_Table {
	...
	public function define_bulk_actions( $actions ) {
		...
		$actions['mark_confirmed'] = __( 'Change status to confirmed', 'woocommerce' );
		$actions['mark_processing'] = __( 'Change status to processing', 'woocommerce' );
        $actions['mark_processed']  = __( 'Change status to processed', 'woocommerce' );
		$actions['mark_delivery']  = __( 'Change status to delivery', 'woocommerce' );
		$actions['mark_completed']  = __( 'Change status to completed', 'woocommerce' );
		$actions['mark_failed'] = __( 'Change status to failed', 'woocommerce' );
	...
	protected function render_filters() {
		...
		?>
		<select class="wc-customer-search" id="wc-customer-search-id" name="_customer_user" data-placeholder="<?php esc_attr_e( 'Filter by registered customer', 'woocommerce' ); ?>" data-allow_clear="true">
