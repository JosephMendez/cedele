...
<table class="wc-shipping-zones widefat">
	<thead>
		<tr>
			...
			<th class="wc-shipping-zone-name" style="width: 35%"><?php esc_html_e( 'Zone name', 'woocommerce' ); ?></th>
			<th class="wc-shipping-zone-region"><?php esc_html_e( 'Region(s)', 'woocommerce' ); ?></th>
			<?php if (false): ?><th class="wc-shipping-zone-methods"><?php esc_html_e( 'Shipping method(s)', 'woocommerce' ); ?></th><?php endif; ?>
		</tr>
	</thead>
