...
<div id="linked_product_data" class="panel woocommerce_options_panel hidden">
    ...
    <div class="options_group show_if_grouped">
        <p class="form-field">
            ...
            <select class="wc-product-search" multiple="multiple" style="width: 50%;" id="grouped_products"
    ...
    <div class="options_group">
        <p class="form-field">
            ...
            <select class="wc-product-search" multiple="multiple" style="width: 50%;" id="upsell_ids"
                    name="upsell_ids[]"
                    data-placeholder="<?php esc_attr_e('Search for a product&hellip;', 'woocommerce'); ?>"
        ...
        <p class="form-field hide_if_grouped hide_if_external">
            ...
            <select class="wc-product-search" multiple="multiple" style="width: 50%;" id="crosssell_ids"
                    name="crosssell_ids[]"
                    data-placeholder="<?php esc_attr_e('Search for a product&hellip;', 'woocommerce'); ?>"
                    data-action="woocommerce_json_search_products_and_variations"
                    data-exclude="<?php echo intval($post->ID); ?>">
...
<script>
    function validateLeng() {
        jQuery(document).ready(function ($) {
            $('#_custom_product_additional_linked').select2({
