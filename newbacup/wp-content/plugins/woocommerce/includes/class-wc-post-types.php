	...
	public static function register_post_status() {
		...
		$order_statuses = apply_filters(
			...
			array(
				...
				'wc-delivery'     => array(
					'label'                     => _x( 'Delivery', 'Order status', 'woocommerce' ),
					'public'                    => false,
					'exclude_from_search'       => false,
					'show_in_admin_all_list'    => true,
					'show_in_admin_status_list' => true,
					/* translators: %s: number of orders */
					'label_count'               => _n_noop( 'Delivery <span class="count">(%s)</span>', 'Delivery <span class="count">(%s)</span>', 'woocommerce' ),
				),
				'wc-completed'  => array(
                ...
                'wc-processed'     => array(
                    'label'                     => _x( 'Processed', 'Order status', 'woocommerce' ),
                    'public'                    => false,
                    'exclude_from_search'       => false,
                    'show_in_admin_all_list'    => true,
                    'show_in_admin_status_list' => true,
                    /* translators: %s: number of orders */
                    'label_count'               => _n_noop( 'Processed <span class="count">(%s)</span>', 'Processed <span class="count">(%s)</span>', 'woocommerce' ),
                ),
			)
		);
