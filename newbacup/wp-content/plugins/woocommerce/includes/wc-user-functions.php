...
if ( ! function_exists( 'wc_create_new_customer' ) ) {
	 ...
	 */
	function wc_create_new_customer( $email, $username = '', $password = '', $args = array(), $sendEmail = true, $edenred_id = null) {
		...
		$new_customer_data = apply_filters(
			...
			array_merge(
				...
				array(
					...
					'user_email' => $email,
					'role'       => 'customer',
                    'edenred_id' => $edenred_id
				)
			)
		);

		$customer_id = wp_insert_user( $new_customer_data, $sendEmail);
