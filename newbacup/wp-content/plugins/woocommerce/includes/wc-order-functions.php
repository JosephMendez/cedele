...
function wc_get_order_statuses() {
	$order_statuses = array(
		'wc-created' => _x( 'Created', 'Order status', 'woocommerce' ),
		'wc-confirmed' => _x( 'Confirmed', 'Order status', 'woocommerce' ),
		'wc-processing' => _x( 'Processing', 'Order status', 'woocommerce' ),
        'wc-processed'     => _x( 'Processed', 'Order Processed', 'woocommerce' ),
		'wc-delivery' => _x( 'Delivery', 'Order status', 'woocommerce' ),
