...
class WC_Shipping_Zone extends WC_Legacy_Shipping_Zone {
	 ...
	 * @return string
	 */
	public function get_zone_toll( $context = 'view' ) {
		return $this->get_prop( 'zone_toll', $context );
	}

    /**
     * Get zone toll extra fee.
     *
     * @param  string $context View or edit context.
     * @return string
     */
    public function get_zone_extra_fee( $context = 'view' ) {
        return $this->get_prop( 'zone_extra_fee', $context );
    }
	 ...
	 * @param string $set Value to set.
	 */
	public function set_zone_toll( $set ) {
		$this->set_prop( 'zone_toll', wc_clean( $set ) );
	}
     ...
     * @param string $set Value to set.
     */
    public function set_zone_extra_fee( $set ) {
        $this->set_prop( 'zone_extra_fee', wc_clean( $set ) );
    }
