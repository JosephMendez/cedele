...
return array(
	...
	'RS' => array(),
	'SG' => array(
		'AMK' => __( 'Ang Mo Kio', 'woocommerce' ),
		'SESA' => __( 'Sentosa', 'woocommerce' ),
		'JUND' => __( 'Jurong Island', 'woocommerce' ),
		'JURD' => __( 'Jurong Shipyard', 'woocommerce' ),
		'JURT' => __( 'Jurong Port', 'woocommerce' ),
//        Sentosa, Jurong Island, Jurong Shipyard, Jurong Port
		'BD' => __( 'Bedok', 'woocommerce' ),
		'BS' => __( 'Bishan', 'woocommerce' ),
		'BL' => __( 'Boon Lay', 'woocommerce' ),
		'BB' => __( 'Bukit Batok', 'woocommerce' ),
		'BM' => __( 'Bukit Merah', 'woocommerce' ),
		'BP' => __( 'Bukit Panjang', 'woocommerce' ),
		'BT' => __( 'Bukit Timah', 'woocommerce' ),

		'CWC' => __( 'Central Water Catchment', 'woocommerce' ),
		'C' => __( 'Changi', 'woocommerce' ),
		'CB' => __( 'Changi Bay', 'woocommerce' ),
		'CCK' => __( 'Choa Chu Kang', 'woocommerce' ),
		'CL' => __( 'Clementi', 'woocommerce' ),
		'DC' => __( 'Downtown Core', 'woocommerce' ),
		'GL' => __( 'Geylang', 'woocommerce' ),
		'HG' => __( 'Hougang', 'woocommerce' ),

		'JE' => __( 'Jurong East', 'woocommerce' ),
		'JW' => __( 'Jurong West', 'woocommerce' ),
		'KL' => __( 'Kallang', 'woocommerce' ),
		'LCK' => __( 'Lim Chu Kang', 'woocommerce' ),
		'MD' => __( 'Mandai', 'woocommerce' ),
		'ME' => __( 'Marina East', 'woocommerce' ),
		'MS' => __( 'Marina South', 'woocommerce' ),
		'MP' => __( 'Marine Parade', 'woocommerce' ),

		'MU' => __( 'Museum', 'woocommerce' ),
		'NT' => __( 'Newton', 'woocommerce' ),
		'NEI' => __( 'North-Eastern Islands', 'woocommerce' ),
		'NV' => __( 'Novena', 'woocommerce' ),
		'OC' => __( 'Orchard', 'woocommerce' ),
		'OT' => __( 'Outram', 'woocommerce' ),
		'PR' => __( 'Pasir Ris', 'woocommerce' ),
		'PL' => __( 'Paya Lebar', 'woocommerce' ),

		'PIN' => __( 'Pioneer', 'woocommerce' ),
		'PGG' => __( 'Punggol', 'woocommerce' ),
		'QS' => __( 'Queenstown', 'woocommerce' ),
		'RV' => __( 'River Valley', 'woocommerce' ),
		'RC' => __( 'Rochor', 'woocommerce' ),
		'SLT' => __( 'Seletar', 'woocommerce' ),
		'SBW' => __( 'Sembawang', 'woocommerce' ),
		'SK' => __( 'Sengkang', 'woocommerce' ),

		'SRN' => __( 'Serangoon', 'woocommerce' ),
		'SP' => __( 'Simpang', 'woocommerce' ),
		'SRR' => __( 'Singapore River', 'woocommerce' ),
		'SI' => __( 'Southern Islands', 'woocommerce' ),
		'SVW' => __( 'Straits View', 'woocommerce' ),
		'SKD' => __( 'Sungei Kadut', 'woocommerce' ),
		'TP' => __( 'Tampines', 'woocommerce' ),
		'TLN' => __( 'Tanglin', 'woocommerce' ),

		'TGH' => __( 'Tengah', 'woocommerce' ),
		'TPH' => __( 'Toa Payoh', 'woocommerce' ),
		'TUAS' => __( 'Tuas', 'woocommerce' ),
		'WIS' => __( 'Western Islands', 'woocommerce' ),
		'WWC' => __( 'Western Water Catchment', 'woocommerce' ),
		'WLS' => __( 'Woodlands', 'woocommerce' ),
		'YSN' => __( 'Yishun', 'woocommerce' ),
	),
	'SK' => array(),
	'SI' => array(),
