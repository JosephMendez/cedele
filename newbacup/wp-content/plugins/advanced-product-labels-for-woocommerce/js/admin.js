...
(function ($){
    ...
    $(document).ready( function () {
        ...
        $(document).on('change', '.berocket_label_type_select', function() {
            ...
            var 
                hideInTitle = $('[name="br_labels[line]"], [name="br_labels[zindex]"]')
                    .closest('tr')
                    .add('[name="br_labels[position]"] option[value="center"]');
        ...
        $(document).on('change', 
            '.br_alabel_settings input, .br_alabel_settings textarea, .br_alabel_settings select, .br_alabel_settings input[name="br_labels[template]"]', function() {
        ...
        function br_apl_reload_labels_preview_ajax(form) {
            ...
            br_label_ajax_demo = $.post(ajaxurl, form_data+'&action=br_label_ajax_demo', function(data) {
                ...
                $('.berocket_alabel_id_demo').addClass('berocket_alabel_demo_' + $('[name="br_labels[position]"]').val() );
